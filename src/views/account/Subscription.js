...
class Subscription extends React.Component {
  ...
  componentDidMount() {
    this.stripeCheckout = window.StripeCheckout.configure({
      ...
      name: "Ellmoe",
      description: "Subscribe to Ellmoe",
    ...
    return (
      <EllmoeSubscription>
        {({ error, isLoading, subscription }) => {
          ...
          const cancelConfirmation = `Are you sure you want to cancel your subscription? You won't have access to paid Ellmoe features.`;
